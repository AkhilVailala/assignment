...
public class Calling 
{
	...
	public static final String URLTOCONNECT = "jdbc:mysql://localhost:3306/akhilmaven";
...
//						System.out.print("ID: " + theResultSet.getString("id"));
						System.out.print(", Name :" + theResultSet.getString("student name"));
